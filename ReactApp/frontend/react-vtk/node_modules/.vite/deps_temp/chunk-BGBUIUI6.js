...
function extractBinary(arrayBuffer, prefixRegex) {
  var suffixRegex = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null;
...
function processDataArray(size, dataArrayElem, compressor, byteOrder, headerType, binaryBuffer) {
  ...
  var format = dataArrayElem.getAttribute("format");
...
function vtkXMLReader(publicAPI, model) {
  ...
  publicAPI.parseAsArrayBuffer = function(arrayBuffer) {
    ...
    var _extractAppendedData = extractAppendedData(arrayBuffer), content = _extractAppendedData.text, binaryBuffer = _extractAppendedData.binaryBuffer;
...
//# sourceMappingURL=chunk-BGBUIUI6.js.map
