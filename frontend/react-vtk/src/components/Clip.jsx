...
const Clip = (props) => {
  ...
  useEffect(() => {
    if (!context.current) {
      ...
      document
        .querySelector(".plane1Rotation")
        .addEventListener("input", (e) => {
          const changedDegree =
            Number(e.target.value) - clipPlane1RotationAngle;
      ...
      document
        .querySelector(".plane2Rotation")
        .addEventListener("input", (e) => {
          const changedDegree =
            Number(e.target.value) - clipPlane2RotationAngle;
